...
public class NewSwerveDriveSubsystem extends SubsystemBase {
    ...
    public NewSwerveDriveSubsystem(SwerveModuleFalcon500[] swerveModules, Pigeon2 pigeon2) {
        ...
        setpointGenerator = new SwerveSetpointGenerator(kinematics,frontLeftLocation, frontRightLocation, backLeftLocation, backRightLocation);
        ...
        setpoint = new SwerveSetpoint(new ChassisSpeeds(),moduleStatesNoCheese);
        printAllCANCoders();
    ...
    public void periodic() {
        ...
        this.setpoint = setpointGenerator.generateSetpoint(this.setpoint, after_skew_velocity,0.12);
