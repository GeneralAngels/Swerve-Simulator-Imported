...
public class CheesyChassisSpeeds {
     ...
     */
    public static CheesyChassisSpeeds fromFieldRelativeSpeeds(
            double vxMetersPerSecond,
            double vyMetersPerSecond,
            double omegaRadiansPerSecond,
            CheesyRotation2d robotAngle) {
    ...
    public static CheesyChassisSpeeds fromRobotRelativeSpeeds(
            double vxMetersPerSecond,
            double vyMetersPerSecond,
            double omegaRadiansPerSecond) {
        return new CheesyChassisSpeeds(vxMetersPerSecond, vyMetersPerSecond, omegaRadiansPerSecond);
    }

    public CheesyTwist2d toTwist2d() {
        return new CheesyTwist2d(vxMetersPerSecond, vyMetersPerSecond, omegaRadiansPerSecond);
    }
